...
`Main.js`(`loadConfig`)는 이제 하드코딩된 설정값 대신 각 구글 프로젝트의 **Script Properties**에서 환경 변수를 동적으로 읽어서 동작합니다. 아래 표의 속성값들을 각 스프레드시트에 연결된 Apps Script 온라인 편집기에서 설정해 주셔야 합니다.
